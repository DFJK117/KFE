# KFE · KadeFuck Engine（简体中文）

> 这是 `KFE.md` 的中文版，内容与英文版一致。
> [English version](KFE.md)
...
| **作者** | **京葉Viii** |
| **辅助生成** | 本项目由 **Hy4** 辅助生成 |
| **灵感来源** | 研究 KE 的 bob 的 lua，于是想着造一个精通 KE 的模组引擎 |
| **底座源码** | [`kadedev/Kade-Engine` @ tag `1.8`](https://github.com/kadedev/Kade-Engine) |
| **许可** | 沿用底座原 `LICENSE` |
| **文档** | [English version](KFE.md) |
